...
public final class FilenameResolver {
    ...
    private static final String defaultMainDir = "C:/Program Files/Paradox Interactive/Europa Universalis 3";
    ...
    private void initDirNames(File cfgFile) {
        ...
        String modDir = "";
        if (cfg != null) {
            mainDir = cfg.getString("maindir");
            modDir = cfg.getString("moddir");
        }
        if(mainDir.equals("")) {
            try {
                if (System.getProperty("os.name").startsWith("Windows")) {
                    ...
                    Key k = regor.openKey(Regor.HKEY_LOCAL_MACHINE, "SOFTWARE\\Paradox Interactive\\Europa Universalis III");
                    mainDir = new String(regor.readValue(k, "path")).replaceAll("\0", "");
                }
                else {
                ...
                e.printStackTrace();
                System.out.println("using default mod dir");
    ...
    public void setMainDirectory(String dirName) {
        System.out.println("Set main directory to " + dirName);
        mainDirName = dirName;
